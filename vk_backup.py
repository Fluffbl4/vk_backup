...
class PhotoDownloader:
    ...
    def get_max_size_photos(self):
        try:
            photos = self.session.photos.get(owner_id=self.user_id, album_id="profile", extended=1)["items"]
        except Exception as e:
        ...
        for photo in max_size_photos:
            ...
            if f"{photo['likes_count']}.jpg" not in existing_files:
                ...
                if response.status_code == 200:
                    ...
                    success = self.upload_to_ya_disk(image_data, filename)
    ...
    def auth_to_ya_disk(self, ya_disk_token):
        self.ya_disk_token = ya_disk_token
    ...
    def upload_to_ya_disk(self, file_data, filename):
        ...
        if response.status_code == 200:
            ...
            if put_response.status_code == 201:
                ...
                print(f'Ошибка при загрузке файла: {put_response.text}')
                return False
        else:
